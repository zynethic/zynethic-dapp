...
export async function POST(req: Request) {
  try {
    ...
    const tweetText = `🏛️ ZYNETHIC GOVERNANCE UPDATE Proposal: ${proposalTitle} Status: ✅ CLOSED Final Results: • Option A: ${resultA}% • Option B: ${resultB}% • Total Weight: ${totalVotes.toLocaleString()} $ZNTC The voting results are officially finalized. ZYNETHIC community has reached a consensus. Initiating the next phase of AI + Web3 evolution on @Base... 🚀 Check: zynethic.xyz #ZYNETHIC #ZNTC #BuildOnBase #AI`;
